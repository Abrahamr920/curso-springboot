...
import com.abraham.curso.springboot.error.springboot_error.exeptions.UserNotFoundException;
import com.abraham.curso.springboot.error.springboot_error.models.Error;
...
public class HandlerExceptionController {
    ...
    public ResponseEntity<Error> divisionByZero(Exception e) {
        ...
        error.setError("Division por zero.");
    ...
    public Map<String, Object> numberFormatException(Exception e) {
        ...
        error.put("error", "Numero invalido, contiene letras.");
    ...
    @ExceptionHandler({ NullPointerException.class, HttpMessageNotWritableException.class,
            UserNotFoundException.class, RuntimeException.class })
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
